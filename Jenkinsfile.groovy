node {
   properties([parameters([string(defaultValue: '127.0.0.1', description: 'Please add IP address to host the website', name: 'DEVIP', trim: true)]), pipelineTriggers([pollSCM('* * * * * ')])])
 stage("Pull git") {
